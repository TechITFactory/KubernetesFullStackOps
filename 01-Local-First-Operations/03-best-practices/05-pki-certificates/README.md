# 05 PKI Certificates and Requirements — teaching transcript
...
You have completed **03 Best Practices**. Continue to [Part 2: Concepts](../../../02-Core-Workloads/README.md).
...
bash 02-Core-Workloads/scripts/verify-part2-prerequisites.sh
