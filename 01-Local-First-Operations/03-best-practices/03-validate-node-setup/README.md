...
cd "$COURSE_DIR/C:/src/K8sOps/01-Local-First-Operations/03-best-practices/03-validate-node-setup"
```
...
[04 Enforcing Pod Security Standards](../04-enforcing-pod-security-standards/README.md)
