# 07 Turnkey Cloud Solutions — teaching transcript
...
Continue to [Part 2 Concepts](../../../02-Core-Workloads/README.md) when your syllabus says so — concepts apply identically on managed clusters. From the repo root, run `bash 02-Core-Workloads/scripts/verify-part2-prerequisites.sh` before **2.1**.
