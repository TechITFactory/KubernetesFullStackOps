...
You already have a cluster from **Minikube (01.1)** **or** **Kind (01.2)**. This lesson adds a **workspace** you will reuse: namespace **`dev-local`**, a **ResourceQuota** (namespace budget), a **LimitRange** (default container resources), and a small **whoami** app.
...
cd "$COURSE_DIR/C:/src/K8sOps/01-Local-First-Operations/01-learning-environment/03-local-dev-clusters"
```
...
**Expected:**  
Path ends with `03-local-development-clusters`.
