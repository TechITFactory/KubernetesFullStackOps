...
# Lesson: part-1-getting-started/1.3-best-practices (module README)
#
...
#
# Run per-lesson scripts from each 1.3.x folder when you finish that lesson (some need
...
echo "Next: work through 1.3.1 → 1.3.5 READMEs and run each lesson's own commands/scripts."
