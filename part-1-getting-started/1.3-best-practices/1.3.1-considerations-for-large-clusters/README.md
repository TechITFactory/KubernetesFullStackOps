...
cd "$COURSE_DIR/part-1-getting-started/1.3-best-practices/1.3.1-considerations-for-large-clusters"
```
...
Path ending with `1.3.1-considerations-for-large-clusters`.
