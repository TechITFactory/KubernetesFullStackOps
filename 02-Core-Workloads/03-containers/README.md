# Containers — teaching transcript
...
**Prerequisites:** [Part 1](../../01-Local-First-Operations/README.md); [2.1 Overview](../01-overview/README.md) and [2.2 Cluster architecture](../02-cluster-architecture/README.md) help but are not strict gates.
...
[2.4 Workloads](../04-workloads/README.md) (suggested course order).
