# 2.5.4 Gateway API — teaching transcript
...
**Prerequisites:** [2.5.3 Ingress Controllers](../2.5.3-ingress-controllers/README.md).
...
```bash
cd "$(git rev-parse --show-toplevel 2>/dev/null)/part-2-concepts/2.5-services-load-balancing-and-networking/2.5.4-gateway-api" 2>/dev/null || cd .
```
