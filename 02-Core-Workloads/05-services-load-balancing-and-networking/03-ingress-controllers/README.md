# 2.5.3 Ingress Controllers — teaching transcript
...
**Prerequisites:** [2.5.2 Ingress](../2.5.2-ingress/README.md).
...
```bash
cd "$(git rev-parse --show-toplevel 2>/dev/null)/part-2-concepts/2.5-services-load-balancing-and-networking/2.5.3-ingress-controllers" 2>/dev/null || cd .
```
