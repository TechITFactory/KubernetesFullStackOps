# 2.4.1.10 Downward API — teaching transcript
...
**Prerequisites:** [2.4.1.9 User Namespaces](../2.4.1.9-user-namespaces/README.md) recommended.
...
```bash
cd "$(git rev-parse --show-toplevel 2>/dev/null)/part-2-concepts/2.4-workloads/2.4.1-pods/2.4.1.10-downward-api" 2>/dev/null || cd .
```
...
[2.4.1.11 Advanced Pod Configuration](../2.4.1.11-advanced-pod-configuration/README.md)
