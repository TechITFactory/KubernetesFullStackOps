# Workload Management — teaching transcript
...
1. [2.4.3.1 Deployments](16-deployments/README.md) — **default stateless app** (transcript + verify).
2. [2.4.3.2 ReplicaSet](17-replicaset/README.md) — what Deployments own under the hood (transcript + verify).
3. [2.4.3.3 StatefulSets](18-statefulsets/README.md) — transcript + `../18-statefulsets/scripts/verify-statefulset-lesson.sh`
4. [2.4.3.4 DaemonSet](19-daemonset/README.md) — transcript + `../19-daemonset/scripts/verify-daemonset-lesson.sh`
5. [2.4.3.5 Jobs](20-jobs/README.md) — transcript + `../20-jobs/scripts/verify-jobs-lesson.sh`
6. [2.4.3.6 Automatic Cleanup for Finished Jobs](21-automatic-cleanup-for-finished-jobs/README.md) — transcript + `../21-automatic-cleanup-for-finished-jobs/scripts/verify-job-ttl-lesson.sh` (waits for TTL deletion)
7. [2.4.3.7 CronJob](22-cronjob/README.md) — transcript + `../22-cronjob/scripts/verify-cronjob-lesson.sh` (`kubectl create job --from=cronjob/...`)
8. [2.4.3.8 ReplicationController](23-replicationcontroller/README.md) — transcript + `../23-replicationcontroller/scripts/verify-replicationcontroller-lesson.sh`
...
- **`rc` visible from old tutorials** → see [2.4.3.8](23-replicationcontroller/README.md) for migration guidance
- **Many pods `Evicted` or `OOMKilled`** → revisit requests/limits ([2.4.1.7](../01-pods/08-pod-quality-of-service-classes/README.md))
