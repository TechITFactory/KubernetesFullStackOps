# 2.4.1.9 User Namespaces — teaching transcript
...
**Prerequisites:** [2.4.1.8 Workload Reference](../2.4.1.8-workload-reference/README.md) recommended.
...
```bash
cd "$(git rev-parse --show-toplevel 2>/dev/null)/part-2-concepts/2.4-workloads/2.4.1-pods/2.4.1.9-user-namespaces" 2>/dev/null || cd .
```
...
[2.4.1.10 Downward API](../2.4.1.10-downward-api/README.md)
