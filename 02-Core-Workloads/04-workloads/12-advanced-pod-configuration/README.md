...
```bash
cd "$(git rev-parse --show-toplevel 2>/dev/null)/part-2-concepts/2.4-workloads/2.4.1-pods/2.4.1.11-advanced-pod-configuration" 2>/dev/null || cd .
```
