# 2.4.2.1 Pod Group Policies — teaching transcript
...
**Prerequisites:** [2.4.2 Workload API](../README.md); [2.4.1.7 QoS](../../2.4.1-pods/2.4.1.7-pod-quality-of-service-classes/README.md) helpful.
...
```bash
cd "$(git rev-parse --show-toplevel 2>/dev/null)/part-2-concepts/2.4-workloads/2.4.2-workload-api/2.4.2.1-pod-group-policies" 2>/dev/null || cd .
```
...
- **Burstable surprise** → LimitRange set **defaultRequest** without matching **default limit**—map to [QoS lesson](../../2.4.1-pods/2.4.1.7-pod-quality-of-service-classes/README.md)
